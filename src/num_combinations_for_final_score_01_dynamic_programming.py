...
# ----------------------------------------------------------------------------
# Dynamic Programming:  Count the number of score combinations
# ----------------------------------------------------------------------------

def num_combinations_for_score(final_score, individual_play_scores):
...
print(num_combinations_for_score(final_score, individual_play_scores))


# -->
# 4 ways to get to final_score = 12
#  - 2 * 6
#  - 2 + 3 + 7
#  - 2 * 3 + 3 * 2
#  - 3 * 4
