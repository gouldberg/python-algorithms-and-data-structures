...
# Note that this method seems to be a O(n^2) method,
...
def stripClosest(strip, size, d):
    ...
    # try the next points till the difference between y coordinates is smaller than d.
...
def closestUtil(P, Q, n):
    ...
    # Build an array strip[] that contains points
    # close (closer than d) to the line passing through the middle point
    stripP = []
    stripQ = []
    lr = Pl + Pr
    for i in range(n):
